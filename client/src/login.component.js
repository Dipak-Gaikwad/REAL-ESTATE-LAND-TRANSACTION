    ...
    render() {
        if (this.state.seller || this.state.buyer || this.state.landInspector) {
            return (
                ...
                <div className="bodyC" style={{ overflow: "hidden" }}>
                    <div className="img-wrapper">
                        <img src="https://pbcdn1.podbean.com/imglogo/image-logo/1927153/Terry-Gold-Podbean-Logo-P.png" className="logo" />
                        <div className="wine-text-container">
                            <div className="site-title wood-text">REAL ESTATE LAND TRANSACTION</div>
                        </div>
                    </div>
                    <div className="auth-wrapper" style={{marginTop: "-9%"}}>
