...
class AddLand extends Component {
  ...
  addLand = async () => {
    ...
    } else if ((!Number(this.state.area))) {
      alert("Land Area must be a number in square meter!");
    }else if ((!Number(this.state.price))) {
      alert("Price of Land must be a number!");
    }else if ((!Number(this.state.propertyPID))) {
      alert("Property PID of Land must be a number!");
    }else if ((!Number(this.state.surveyNum))) {
      alert("Survey Number of Land must be a number!");
    }else if ((Number(this.state.city))) {
      alert("Please enter valid city name!");
    }else if ((Number(this.state.stateLoc))) {
              ...
              <CardBody>
                <Form>
                  ...
                  <Row>
                    <Col md="12">
                      <FormGroup>
                        <label>Insert Property document</label>
                        <FormFile
                          id="File2"
